...
const TableNameYmDataNonPartitioned = "ym_data_non_partitioned"

// YmDataNonPartitioned mapped from table <ym_data_non_partitioned>
...
// TableName YmDataNonPartitioned's table name
func (*YmDataNonPartitioned) TableName() string {
	return TableNameYmDataNonPartitioned
}
