...
func newYmData20240125(db *gorm.DB, opts ...gen.DOOption) ymData20240125 {
	...
	_ymData20240125.UtmSource = field.NewString(tableName, "utm_source")
	_ymData20240125.UtmMedium = field.NewString(tableName, "utm_medium")
	_ymData20240125.UtmCampaign = field.NewString(tableName, "utm_campaign")
