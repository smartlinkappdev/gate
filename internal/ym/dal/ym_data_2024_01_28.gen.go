...
func newYmData20240128(db *gorm.DB, opts ...gen.DOOption) ymData20240128 {
	...
	_ymData20240128.UtmSource = field.NewString(tableName, "utm_source")
	_ymData20240128.UtmMedium = field.NewString(tableName, "utm_medium")
	_ymData20240128.UtmCampaign = field.NewString(tableName, "utm_campaign")
