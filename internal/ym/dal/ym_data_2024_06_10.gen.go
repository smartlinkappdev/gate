...
func newYmData20240610(db *gorm.DB, opts ...gen.DOOption) ymData20240610 {
	...
	_ymData20240610.UtmSource = field.NewString(tableName, "utm_source")
	_ymData20240610.UtmMedium = field.NewString(tableName, "utm_medium")
	_ymData20240610.UtmCampaign = field.NewString(tableName, "utm_campaign")
