...
func newYmData20240428(db *gorm.DB, opts ...gen.DOOption) ymData20240428 {
	...
	_ymData20240428.UtmSource = field.NewString(tableName, "utm_source")
	_ymData20240428.UtmMedium = field.NewString(tableName, "utm_medium")
	_ymData20240428.UtmCampaign = field.NewString(tableName, "utm_campaign")
