...
func newYmData20240405(db *gorm.DB, opts ...gen.DOOption) ymData20240405 {
	...
	_ymData20240405.UtmSource = field.NewString(tableName, "utm_source")
	_ymData20240405.UtmMedium = field.NewString(tableName, "utm_medium")
	_ymData20240405.UtmCampaign = field.NewString(tableName, "utm_campaign")
