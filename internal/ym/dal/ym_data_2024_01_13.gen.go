...
func newYmData20240113(db *gorm.DB, opts ...gen.DOOption) ymData20240113 {
	...
	_ymData20240113.UtmSource = field.NewString(tableName, "utm_source")
	_ymData20240113.UtmMedium = field.NewString(tableName, "utm_medium")
	_ymData20240113.UtmCampaign = field.NewString(tableName, "utm_campaign")
