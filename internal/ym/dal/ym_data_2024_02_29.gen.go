...
func newYmData20240229(db *gorm.DB, opts ...gen.DOOption) ymData20240229 {
	...
	_ymData20240229.UtmSource = field.NewString(tableName, "utm_source")
	_ymData20240229.UtmMedium = field.NewString(tableName, "utm_medium")
	_ymData20240229.UtmCampaign = field.NewString(tableName, "utm_campaign")
