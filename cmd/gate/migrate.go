...
func main3() {
	...
	err = conn.AutoMigrate(entity.Preset{}, entity.Filter{})
	//err = conn.AutoMigrate(entity.Filter{})
	//err = conn.AutoMigrate(entity.Filter{}, entity.User{}, entity.Group{}, entity.Link{})
	if err != nil {
		fmt.Println("============", err)
	}
